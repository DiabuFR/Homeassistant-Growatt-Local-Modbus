...
async def async_setup_entry(
    ...
    if device_type in (DeviceTypes.INVERTER, DeviceTypes.INVERTER_315, DeviceTypes.INVERTER_120, DeviceTypes.HYBRIDE_120, DeviceTypes.TL_XH_120):
    ...
    if device_type in (DeviceTypes.HYBRIDE_120, DeviceTypes.STORAGE_120, DeviceTypes.TL_XH_120):
    ...
    elif device_type in (DeviceTypes.HYBRIDE_120, DeviceTypes.TL_XH_120 ):
        power_sensor = (ATTR_INPUT_POWER, ATTR_OUTPUT_POWER,
